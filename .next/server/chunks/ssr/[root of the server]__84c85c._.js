...
const getCharacterByBane = async (name)=>{
    ...
    const res = await fetch(`https://gateway.marvel.com:443/v1/public/characters?nameStartsWith=${name}&apikey=${("TURBOPACK compile-time value", "177126498059691d01bb4f4d4eb60653")}&hash=${hash}`);
    return res;
};
}}),
